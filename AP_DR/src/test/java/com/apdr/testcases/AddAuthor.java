...
public class AddAuthor extends TestBase {
	...
	@Test(priority = 2, dataProviderClass = DataUtils.class, dataProvider = "AuthorCredentials")
	...
	public void select_Users_role() throws InterruptedException {
		addUserObj.RoleselectionForAuthor();
	}
