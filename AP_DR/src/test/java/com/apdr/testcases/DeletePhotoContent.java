...
import com.apdr.pageobjects.DeletePhotoPage;
...
public class DeletePhotoContent extends TestBase {

	public DeletePhotoContent() {
		super();
	}

	HomePage homeObj;
	DeleteContentPage Deleteobj;
	DeletePhotoPage DeletePhoto;

	@BeforeTest
	public void DeletecontentInitialization() {
		homeObj = new HomePage();
		Deleteobj = new DeleteContentPage();
		DeletePhoto = new DeletePhotoPage();
	}
