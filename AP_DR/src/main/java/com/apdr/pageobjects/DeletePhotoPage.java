...
public class DeletePhotoPage extends TestBase {

	public DeletePhotoPage() {
	...
	public void Titlesearchfield() {
		...
		searchfield.sendKeys("Image upload through upgraded Automation testing script");
	}
